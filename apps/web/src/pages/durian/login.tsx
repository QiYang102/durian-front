      ...
      <div className="flex items-center justify-center p-4 py-20 w-full">
        <Card className="w-full max-w-md shadow-xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden">
          <CardHeader className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800 pb-6">
            <CardTitle className="text-3xl text-center text-slate-900 dark:text-white font-extrabold tracking-tight">
              Welcome Back
            </CardTitle>
          ...
          <CardContent className="pt-8">
            <FormProvider {...form}>
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full bg-slate-900 text-white hover:bg-yellow-500 hover:text-slate-950 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-yellow-500 dark:hover:text-slate-950 font-bold py-6 text-lg mt-4 shadow-md transition-all"
                >
                  Sign In
                </Button>
                ...
                <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-4">
                  ...
                  <Link
                    to="/durian/register"
                    className="font-bold text-yellow-600 hover:text-yellow-500 dark:text-yellow-400 dark:hover:text-yellow-300 transition-colors"
                  >
                    Sign Up
                  </Link>
                </p>
