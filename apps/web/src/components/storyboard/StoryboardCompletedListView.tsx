...
interface StoryboardCompletedListViewProps {
  iterationId: string;
}

const StoryboardCompletedListView = ({
  iterationId,
}: StoryboardCompletedListViewProps) => {
            ...
            {shouldCelebrate ? (
              ...
              <>
                ...
                <p className="text-gray-500">
                  No completed stories yet for this iteration
                </p>
              </>
            )}
          </div>
...
export default StoryboardCompletedListView;
